...
- **Presidente da República** — perfil informativo com resumo, foto e links oficiais, **mais análise de gastos completa**: todas as **viagens a serviço** e **contratos da Presidência**, com **filtros (tipo, mês, data, valor, fornecedor/beneficiário)**, indicadores, sinais, **maiores fornecedores** e comprovante no Portal.
